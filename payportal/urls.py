...
urlpatterns = [
    ...
    path('paybeceprivate/<str:pk>/<str:pk2>/',PayBecePrivate, name ="getBeceinformation"),# pay for bece exams form
    ...
    path('jsspayment/<str:pk>/<str:pk2>/', PayJss, name ="getBeceinformation"),# pay for jss exams form
    ...
    path('typejss/<str:pk>/', getTypeJss3Info, name ="get  type jss info"),# get type of school jss info
